...
db.run('CREATE TABLE IF NOT EXISTS messages (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, number TEXT)');

// API endpoint to store messages
app.post('/api/messages', (req, res) => {
  const { name, number } = req.body;
  const query = 'INSERT INTO messages (name, number) VALUES (?, ?)';
